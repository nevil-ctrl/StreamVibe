      ...
      {isAdmin &&
        (isOpen ? (
          <div className="flex items-center gap-2 px-4 py-3 mb-2">
            <LucideIcons.Film className="text-red-500 shrink-0" size={20} />
          ...
          <div className="flex justify-center py-3 mb-2">
            <LucideIcons.Film className="text-red-500" size={20} />
          </div>
        ))}
      ...
      {isAdmin && (
        <div className="border-t border-neutral-900 pt-2 mb-2">
          ...
          <Link
            ...
            <LucideIcons.ArrowLeft size={18} className="shrink-0" />
